...
{
    /// <summary>
    /// Source generator that will generate the necessary API controllers and action to handle the commands and queries in the system.
    /// 
    /// </summary>
    [Generator]
    public class ScGenerator : ISourceGenerator
    {
